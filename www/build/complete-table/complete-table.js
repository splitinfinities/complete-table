...
class CompleteTable {
    ...
    static get properties() { return { "__currentPage": { "state": true }, "__currentPageItems": { "state": true }, "__name": { "state": true }, "__pageArray": { "state": true }, "__pageCount": { "state": true }, "__resizable": { "state": true }, "__resizableState": { "state": true }, "__selected": { "state": true }, "__sortable": { "state": true }, "columns": { "state": true }, "data": { "state": true }, "density": { "type": "Any", "attr": "density" }, "editable": { "type": Boolean, "attr": "editable" }, "element": { "elementRef": true }, "expandable": { "type": Boolean, "attr": "expandable" }, "expandInto": { "type": "Any", "attr": "expand-into" }, "filterable": { "type": Boolean, "attr": "filterable" }, "items": { "type": Number, "attr": "items" }, "pagination": { "type": Boolean, "attr": "pagination", "watchCallbacks": ["observePagination"] }, "raw": { "type": Boolean, "attr": "raw" }, "readability": { "type": "Any", "attr": "readability" }, "resizable": { "type": Boolean, "attr": "resizable", "watchCallbacks": ["observeResizeable"] }, "searchable": { "type": Boolean, "attr": "searchable" }, "selectable": { "type": Boolean, "attr": "selectable" }, "sortable": { "type": Boolean, "attr": "sortable", "watchCallbacks": ["observeSortable"] }, "state": { "method": true }, "sticky": { "type": Boolean, "attr": "sticky" }, "updateData": { "method": true } }; }

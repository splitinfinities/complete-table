...
var Draggable = unwrapExports(draggable);
...
class CompleteTable {
    ...
    applyVersion(version) {
        return __awaiter(this, void 0, void 0, function* () {
            const state = yield this.__history.history
    ...
    updateData(data) {
        ...
        this.data.list = deepmerge_1(this.data.list, data.list);
    ...
    renderSelectColumn(row) {
        ...
        h("div", { class: "td small ignore" },
            h("input", { type: "checkbox", class: "single", value: row[0].id, checked: this.valueSelected(row[0].id), onChange: (e) => { this.handleSelectOne(e); } })));
    }
    renderHeaderDragTab() {
    ...
    renderHeaderSelectColumn() {
        if (this.pagination) {
            ...
            // @ts-ignore
            h("div", { class: "th small ignore" },
                h("input", { type: "checkbox", class: "all", indeterminate: this.__selected.length !== this.data.list.length && this.__selected.length !== 0, onChange: (e) => { this.handleSelectAll(e); } })));
        }
    }
    renderTableHead() {
    ...
    renderTableHeadColumnName(item) {
        return (h("div", { class: "th" },
            this.resizable && h("button", { class: "resize-handle" }),
    ...
    renderTableRow(row, index) {
        ...
        return (h("div", { class: `tr ${selected}`, "data-index": index, "data-version": this.data.version },
    ...
    renderTableCell(item, index) {
        return (h("div", { class: "td", "data-index": index, innerHTML: this.raw ? item.content : undefined, onDblClick: (e) => { this.handleCellDoubleClick(e, item.content); } }, !this.raw ? item.content : undefined));
    }
    renderPageSelect() {
        return (h("div", { class: "td" },
            h("select", { onChange: (e) => { this.updateCurrentPage(e.target); } }, this.__pageArray && this.__pageArray.map((item) => {
                return h("option", { selected: this.__currentPage === item, value: item }, item + 1);
            }))));
    }
    ...
    renderSelectedItems() {
        return this.__selected.map((value) => {
            return h("input", { type: "hidden", name: this.__name, value: value, checked: true });
        });
    }
    render() {
        return (

...
class CompleteTable {
    ...
    renderSelectColumn(index) {
        return (h("div", { class: "td small ignore" },
            h("input", { type: "checkbox", class: "single", value: index, onChange: (e) => { this.handleSelectOne(e); } })));
    }
    renderHeaderDragTab() {
    ...
    renderHeaderSelectColumn() {
        return (h("div", { class: "th small ignore" },
            h("input", { type: "checkbox", class: "all", onChange: (e) => { this.handleSelectAll(e); } })));
    }
    renderTableHead() {

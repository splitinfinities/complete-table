...
class CompleteTable {
    ...
    componentDidLoad() {
        if (this.swappable) {
            const swappable$$1 = new Swappable(this.element.shadowRoot.querySelector('.tbody'), {
                draggable: '.tr',
                handle: '.drag-handle'
            });
    ...
    static get properties() { return { "columns": { "state": true }, "data": { "state": true }, "density": { "type": "Any", "attr": "density" }, "editable": { "type": Boolean, "attr": "editable" }, "element": { "elementRef": true }, "expandable": { "type": Boolean, "attr": "expandable" }, "expandInto": { "type": "Any", "attr": "expand-into" }, "filterable": { "type": Boolean, "attr": "filterable" }, "header": { "type": "Any", "attr": "header" }, "items": { "type": Number, "attr": "items" }, "pagination": { "type": Boolean, "attr": "pagination" }, "raw": { "type": Boolean, "attr": "raw" }, "readability": { "type": "Any", "attr": "readability" }, "resizable": { "type": Boolean, "attr": "resizable" }, "searchable": { "type": Boolean, "attr": "searchable" }, "selectable": { "type": Boolean, "attr": "selectable" }, "sortable": { "type": Boolean, "attr": "sortable" }, "state": { "method": true }, "swappable": { "type": Boolean, "attr": "swappable" } }; }
    static get style() { return "[data-complete-table-host] {\n  --table-border-color: rgba(0,0,0,0.2);\n  --table-box-shadow: rgba(0,0,0,0.15);\n  --table-font-size: 1.6rem;\n  display: block;\n  box-sizing: border-box;\n}\n\n[data-complete-table-host]   *[data-complete-table] {\n  box-sizing: border-box;\n}\n\n[data-complete-table-host]   .table[data-complete-table] {\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  border: 1px solid var(--table-border-color);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .table[data-complete-table] {\n  flex: auto 1;\n  display: flex;\n  flex-direction: column;\n  align-items: stretch;\n  width: 100%;\n  border-collapse: collapse;\n  overflow: auto;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table] {\n  flex: 1 0 auto;\n  display: flex;\n  flex-direction: column;\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead.-headerGroups[data-complete-table] {\n  background: rgba(0,0,0,0.03);\n  border-bottom: 1px solid var(--table-border-color);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead.-filters[data-complete-table] {\n  border-bottom: 1px solid var(--table-border-color);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead.-filters[data-complete-table]   input[data-complete-table], [data-complete-table-host]   .table[data-complete-table]   .thead.-filters[data-complete-table]   select[data-complete-table] {\n  border: 1px solid var(--table-border-color);\n  background: #fff;\n  padding: 5px 7px;\n  font-size: inherit;\n  border-radius: 3px;\n  font-weight: normal;\n  outline: none;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead.-filters[data-complete-table]   .th[data-complete-table] {\n  border-right: 1px solid var(--table-border-color);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead.-header[data-complete-table] {\n  box-shadow: 0 2px 15px 0px var(--table-box-shadow);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .tr[data-complete-table] {\n  text-align: center;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .th[data-complete-table], [data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .td[data-complete-table] {\n  padding: 5px 5px;\n  line-height: normal;\n  position: relative;\n  border-right: 1px solid var(--table-border-color);\n  transition: box-shadow 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);\n  box-shadow: inset 0 0 0 0 transparent;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .th.-soasc[data-complete-table], [data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .td.-soasc[data-complete-table] {\n  box-shadow: inset 0 3px 0 0 var(--table-box-shadow);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .th.-sodesc[data-complete-table], [data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .td.-sodesc[data-complete-table] {\n  box-shadow: inset 0 -3px 0 0 var(--table-box-shadow);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .th.-cursor-pointer[data-complete-table], [data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .td.-cursor-pointer[data-complete-table] {\n  cursor: pointer;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .th[data-complete-table]:last-child, [data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .td[data-complete-table]:last-child {\n  border-right: 0;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .resizable-header[data-complete-table] {\n  overflow: visible;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .resizable-header[data-complete-table]:last-child {\n  overflow: hidden;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .resizable-header-content[data-complete-table] {\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .header-pivot[data-complete-table] {\n  border-right-color: var(--table-border-color);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .header-pivot[data-complete-table]::after, [data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .header-pivot[data-complete-table]::before {\n  left: 100%;\n  top: 50%;\n  border: solid transparent;\n  content: \" \";\n  height: 0;\n  width: 0;\n  position: absolute;\n  pointer-events: none;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .header-pivot[data-complete-table]::after {\n  border-color: rgba(255,255,255,0);\n  border-left-color: #fff;\n  border-width: 8px;\n  margin-top: -8px;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .thead[data-complete-table]   .header-pivot[data-complete-table]::before {\n  border-color: rgba(102,102,102,0);\n  border-left-color: var(--table-border-color);\n  border-width: 10px;\n  margin-top: -10px;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .tbody[data-complete-table] {\n  flex: 99999 1 auto;\n  display: flex;\n  flex-direction: column;\n  overflow: auto;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .tbody[data-complete-table]   .tr-group[data-complete-table] {\n  border-bottom: solid 1px var(--table-border-color);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .tbody[data-complete-table]   .tr-group[data-complete-table]:last-child {\n  border-bottom: 0;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .tbody[data-complete-table]   .td[data-complete-table] {\n  border-right: 1px solid var(--table-border-color);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .tbody[data-complete-table]   .td[data-complete-table]:last-child {\n  border-right: 0;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .tbody[data-complete-table]   .expandable[data-complete-table] {\n  cursor: pointer;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .tr-group[data-complete-table] {\n  flex: 1 0 auto;\n  display: flex;\n  flex-direction: column;\n  align-items: stretch;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .tr[data-complete-table] {\n  flex: 1 0 auto;\n  display: inline-flex;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .th[data-complete-table], [data-complete-table-host]   .table[data-complete-table]   .td[data-complete-table] {\n  flex: 1 0 0px;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  padding: 7px 5px;\n  overflow: hidden;\n  transition: 0.3s ease;\n  transition-property: width, min-width, padding, opacity;\n  font-size: var(--font-size);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .th.-hidden[data-complete-table], [data-complete-table-host]   .table[data-complete-table]   .td.-hidden[data-complete-table] {\n  width: 0 !important;\n  min-width: 0 !important;\n  padding: 0 !important;\n  border: 0 !important;\n  opacity: 0 !important;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .expander[data-complete-table] {\n  display: inline-block;\n  position: relative;\n  margin: 0;\n  color: transparent;\n  margin: 0 10px;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .expander[data-complete-table]::after {\n  content: '';\n  position: absolute;\n  width: 0;\n  height: 0;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%) rotate(-90deg);\n  border-left: 5.04px solid transparent;\n  border-right: 5.04px solid transparent;\n  border-top: 7px solid var(--table-border-color);\n  transition: all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);\n  cursor: pointer;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .expander.-open[data-complete-table]::after {\n  transform: translate(-50%, -50%) rotate(0deg);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .resizer[data-complete-table] {\n  display: inline-block;\n  position: absolute;\n  width: 36px;\n  top: 0;\n  bottom: 0;\n  right: -18px;\n  cursor: col-resize;\n  z-index: 10;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .tfoot[data-complete-table] {\n  flex: 1 0 auto;\n  display: flex;\n  flex-direction: column;\n  box-shadow: 0 0px 15px 0px rgba(0,0,0,0.15);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .tfoot[data-complete-table]   .td[data-complete-table] {\n  border-right: 1px solid var(--table-border-color);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .tfoot[data-complete-table]   .td[data-complete-table]:last-child {\n  border-right: 0;\n}\n\n[data-complete-table-host]   .table.-striped[data-complete-table]   .tr.-odd[data-complete-table] {\n  background: rgba(0,0,0,0.03);\n}\n\n[data-complete-table-host]   .table.-highlight[data-complete-table]   .tbody[data-complete-table]   .tr[data-complete-table]:not(.-padRow):hover {\n  background: rgba(0,0,0,0.05);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .-pagination[data-complete-table] {\n  z-index: 1;\n  display: flex;\n  justify-content: space-between;\n  align-items: stretch;\n  flex-wrap: wrap;\n  padding: 3px;\n  box-shadow: 0 0px 15px 0px rgba(0,0,0,0.1);\n  border-top: 2px solid var(--table-border-color);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .-pagination[data-complete-table]   input[data-complete-table], [data-complete-table-host]   .table[data-complete-table]   .-pagination[data-complete-table]   select[data-complete-table] {\n  border: 1px solid var(--table-border-color);\n  background: #fff;\n  padding: 5px 7px;\n  font-size: inherit;\n  border-radius: 3px;\n  font-weight: normal;\n  outline: none;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .-pagination[data-complete-table]   .-btn[data-complete-table] {\n  appearance: none;\n  display: block;\n  width: 100%;\n  height: 100%;\n  border: 0;\n  border-radius: 3px;\n  padding: 6px;\n  font-size: 1em;\n  color: rgba(0,0,0,0.6);\n  background: rgba(0,0,0,0.1);\n  transition: all 0.1s ease;\n  cursor: pointer;\n  outline: none;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .-pagination[data-complete-table]   .-btn[disabled][data-complete-table] {\n  opacity: 0.5;\n  cursor: default;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .-pagination[data-complete-table]   .-btn[data-complete-table]:not([disabled]):hover {\n  background: rgba(0,0,0,0.3);\n  color: #fff;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .-pagination[data-complete-table]   .-previous[data-complete-table], [data-complete-table-host]   .table[data-complete-table]   .-pagination[data-complete-table]   .-next[data-complete-table] {\n  flex: 1;\n  text-align: center;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .-pagination[data-complete-table]   .-center[data-complete-table] {\n  flex: 1.5;\n  text-align: center;\n  margin-bottom: 0;\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  align-items: center;\n  justify-content: space-around;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .-pagination[data-complete-table]   .-pageInfo[data-complete-table] {\n  display: inline-block;\n  margin: 3px 10px;\n  white-space: nowrap;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .-pagination[data-complete-table]   .-pageJump[data-complete-table] {\n  display: inline-block;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .-pagination[data-complete-table]   .-pageJump[data-complete-table]   input[data-complete-table] {\n  width: 70px;\n  text-align: center;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .-pagination[data-complete-table]   .-pageSizeOptions[data-complete-table] {\n  margin: 3px 10px;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .noData[data-complete-table] {\n  display: block;\n  position: absolute;\n  left: 50%;\n  top: 50%;\n  transform: translate(-50%, -50%);\n  background: rgba(255,255,255,0.8);\n  transition: all 0.3s ease;\n  z-index: 1;\n  pointer-events: none;\n  padding: 20px;\n  color: rgba(0,0,0,0.5);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .-loading[data-complete-table] {\n  display: block;\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  background: rgba(255,255,255,0.8);\n  transition: all 0.3s ease;\n  z-index: -1;\n  opacity: 0;\n  pointer-events: none;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .-loading[data-complete-table]    > div[data-complete-table] {\n  position: absolute;\n  display: block;\n  text-align: center;\n  width: 100%;\n  top: 50%;\n  left: 0;\n  font-size: 15px;\n  color: rgba(0,0,0,0.6);\n  transform: translateY(-52%);\n  transition: all 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .-loading.-active[data-complete-table] {\n  opacity: 1;\n  z-index: 2;\n  pointer-events: all;\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .-loading.-active[data-complete-table]    > div[data-complete-table] {\n  transform: translateY(50%);\n}\n\n[data-complete-table-host]   .table[data-complete-table]   .resizing[data-complete-table]   .th[data-complete-table], [data-complete-table-host]   .table[data-complete-table]   .resizing[data-complete-table]   .td[data-complete-table] {\n  transition: none !important;\n  cursor: col-resize;\n  user-select: none;\n}"; }
}
